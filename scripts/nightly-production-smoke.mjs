...
const checks = [
  ...
  runCheck("postdeploy_browserbase_capture", ["scripts/postdeploy-browserbase-smoke.mjs", base], {}),
...
const packet = {
  ...
  gates: {
    ...
    browserbase_capture: checks[2]?.status === "pass",
    training_export_download: checks[3]?.status === "pass",

...
const required = [
  ...
  "sso:/domains",
  "Vercel GitHub Integration Attached, Awaiting Commit-Triggered Deployment Verification",
  "Jeremyjones23/aculeus-slm-frontend is already connected to your project",
  "The remaining proof is a fresh commit from `main` creating a Vercel deployment",

...
const headers = {
  ...
  "x-clerk-user-id": process.env.ACULEUS_SMOKE_USER_ID || "postdeploy_admin_operator",
  "x-aculeus-email": process.env.ACULEUS_SMOKE_EMAIL || "admin@aculeus.local",
  "x-aculeus-role": process.env.ACULEUS_SMOKE_ROLE || "admin",
